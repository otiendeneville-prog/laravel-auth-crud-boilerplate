...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <h1 class="text-3xl font-bold text-white mb-8">Edit Idea</h1>

        <form method="POST" action="/ideas/{{ $idea->id }}" class="bg-gray-800 rounded-lg p-6 border border-gray-700">
            @csrf
            @method('PATCH')
